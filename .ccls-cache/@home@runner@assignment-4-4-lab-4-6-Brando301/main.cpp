...
{ 
 int selection;
  cout << "Which formula do you want to see?nn"; 
 cout << "1. Area of a circle"; 
 cout << "2. Area of a rectangle"; 
 cout << "3. Volume of a cylinder"; 
cout << "4. None of them!n";  
cin >> selection;  
switch(selection){ case 1: cout << "Pi times radius squared"; 
 break; 
  case 2: cout << "Length times widthn";
  break; 
  case 3: cout << "Pi times radius squared times height";  break; 
  case 4: cout << "Well okay then, good bye!n";  
break; 
ttdefault: cout << "Not good with numbers, eh?n"; 
